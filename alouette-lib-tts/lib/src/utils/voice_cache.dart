...
/// LRU cache for voice lists with expiration and persistence
class VoiceCache {
  static const String _cacheFileName = 'alouette_voice_cache.json';
  ...
  Future<void> saveToStorage() async {
    try {
      ...
      // Ignore save errors - cache will work without persistence
    }
  }
  ...
  Future<File> _getCacheFile() async {
    ...
    final cacheDir = Directory(path.join(directory.path, 'alouette_cache'));
